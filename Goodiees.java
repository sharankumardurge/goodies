import java.util.*;
import java.io.*;
public class Goodiees {
			//static int pos=-1;
	public static void main(String[] args) throws Exception {
		// TODO Auto-generated method stub
		Scanner sc=new Scanner(System.in);
		String path1="C:\\JAVA PROGRAMS\\input.txt";//given input txt with where is the path is located.
		String path2="C:\\JAVA PROGRAMS\\output_file.txt";//given output file and path where is located.

		 FileReader file=new FileReader(path1);//input path
		 BufferedReader bf=new BufferedReader(file);//input file readerr.
		 FileWriter output=new FileWriter(path2,true);//output
		 BufferedWriter bw=new BufferedWriter(output);//output file Writer.
